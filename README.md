...
git clone https://github.com/Risshhhiiii/CNN-Based-Media-Player.git
cd CNN-Based-Media-Player
...
pip install "tensorflow<2.16" opencv-python numpy pandas pyautogui streamlit scikit-learn matplotlib seaborn pillow
```
